...
\begin{titlepage} % Suppresses headers and footers on the title page
    ...
    \noindent\textbf{Part III:} Vector spaces, subspaces, bases, linear transformations, kernels and images, geometry of space, linear operators, inverses, similarity, determinants, traces, spectra, self adjointness, diagonolization, symmetries, and groups.   \\% Subtitle or further description
